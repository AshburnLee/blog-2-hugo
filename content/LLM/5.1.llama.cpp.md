...
## 如何在 llama.cpp 中使用 某个具体的 GGUF文件？

### 通过 -hf 参数
在 HF 的某个具体 gguf 的页面中，点击“Use This Model”，找到llama.cpp，就可以看到具体使用方法了
比如在 [Llama-3.2-1B-Instruct-Q8_0.gguf](https://huggingface.co/lmstudio-community/Llama-3.2-1B-Instruct-GGUF?show_file_info=Llama-3.2-1B-Instruct-Q8_0.gguf)
...
# Load and run the model, 如果是第一次那么会首先下载 model
./build/bin/llama-server -hf lmstudio-community/Llama-3.2-1B-Instruct-GGUF:Q8_0
~~~
...
./build/bin/llama-simple -m ./models/llama-3.2-3b-instruct-q4_k_m.gguf "introduce youself"
./build/bin/llama-simple -m ./models/Llama-3.2-1B-Instruct-Q8_0.gguf "introduce youself"
~~~
